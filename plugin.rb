...
after_initialize do
  ...
  load File.expand_path('../serializers/latest_topics.rb', __FILE__)
  load File.expand_path('../controllers/latest_topics.rb', __FILE__)
  ...
  ::DiscourseNeo4j::Engine.routes.draw do
    ...
    get "/latest_topics" => "latest_topics#topics"
